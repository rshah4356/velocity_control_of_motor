...
// static int calc_pwm(int desired_velocity){
//     static int velocity_err,prev_velocity_err,cum_err = 0;
//     int
//     velocity_err = desired_velocity - motor_velocity;
//     cum_err = velocity_err + prev_velocity_err;
//     pwm = kp*velocity_err - kd*(velocity_err-prev_velocity_err) + ki*cum_err;
//     prev_velocity_err = velocity_err; 
// }
